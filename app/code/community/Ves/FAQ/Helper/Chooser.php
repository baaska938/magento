 ...
 */
class Ves_FAQ_Helper_Chooser extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_DEFAULT_CHOOSER_CONFIG = 'ves_chooser_widget/chooser_defaults';
